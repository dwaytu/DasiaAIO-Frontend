...
describe('ROUTES', () => {
  it('exports all expected route paths', () => {
    ...
    expect(ROUTES.DTR).toBe('/dtr')
    expect(ROUTES.MERIT).toBe('/merit')
    expect(ROUTES.FIREARMS).toBe('/firearms')
    expect(ROUTES.FIREARM_COMPLIANCE).toBe('/firearms/compliance')
    expect(ROUTES.GUARD_COMPLIANCE).toBe('/guards/compliance')
...
describe('VIEW_TO_ROUTE', () => {
  it('maps activeView keys from App.tsx to route paths', () => {
    ...
    expect(VIEW_TO_ROUTE['dtr']).toBe(ROUTES.DTR)
    expect(VIEW_TO_ROUTE['merit']).toBe(ROUTES.MERIT)
    expect(VIEW_TO_ROUTE['firearms']).toBe(ROUTES.FIREARMS)
    expect(VIEW_TO_ROUTE['firearm-compliance']).toBe(ROUTES.FIREARM_COMPLIANCE)
    expect(VIEW_TO_ROUTE['guard-compliance']).toBe(ROUTES.GUARD_COMPLIANCE)
